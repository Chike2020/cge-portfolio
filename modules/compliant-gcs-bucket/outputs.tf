...
output "bucket_url" {
  ...
  description = "URL of your secure bucket"
}

output "bucket_self_link" {
  value       = google_storage_bucket.bucket.self_link
  description = "Full link to the bucket"
}

output "kms_key_id" {
  value       = google_kms_crypto_key.key.id
  description = "Encryption key protecting this bucket"
}

# THIS IS THE COMPLIANCE CERTIFICATE!
output "compliance_attestation" {
  description = "Proof that all security controls are enabled"
  value = {
