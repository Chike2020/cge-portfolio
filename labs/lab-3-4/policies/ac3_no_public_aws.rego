...
# Check all buckets have complete public access blocks
...
# Check if bucket has complete public access block
...
# Find public access block for this bucket
...
# Check if PAB references the bucket
